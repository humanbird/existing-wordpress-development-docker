...
final class RM_EX_MailPoet {
	...
	private function set_actions() { 
        ...
        {
             add_submenu_page("rm_dummy_string", __("RM MailPoet settings", 'registrationmagic-addon'), __("RM MailPoet settings", 'registrationmagic-addon'), "manage_options", "rm_form_sett_mailpoet", array($this,'form_sett_manage'));
        }

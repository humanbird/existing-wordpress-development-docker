...
class RM_WC_Admin {
    ...
    public function admin_menus() {
        add_submenu_page("rm_dummy_string",  __("RM WC setting", 'registrationmagic-addon'), __("RM WC setting", 'registrationmagic-addon'), "manage_options", "rm_wc_settings", 'rm_wc_setting_manage');
    }

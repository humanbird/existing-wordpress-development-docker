...
class DSM_CardCarousel_Child extends ET_Builder_Module {
	...
	public function render( $attrs, $content = null, $render_slug ) {
		...
		$image_alignment_selector = '%%order_class%% .et_pb_module_inner .dsm_card_carousel_child_image_wrapper .dsm_card_carousel_child_img';
		...
		$image_type = sprintf(
			'on' !== $image_as_background ? $image : '<div class="dsm_card_carousel_child_image_background%1$s%2$s"></div>',
			'off' !== $image_popup ? ' dsm-card-image-lightbox dsm-card-lightbox-trigger swiper-no-swiping' : '',
			'off' !== $image_video_popup ? ' dsm-card-video-lightbox dsm-card-lightbox-trigger swiper-no-swiping' : ''
		);

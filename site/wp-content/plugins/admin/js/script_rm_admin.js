...
(function (RM_jQ) {
    ...
    RM_jQ.prevent_field_add = function (event, rm_msg) {
        var ctabIconValue = document.getElementsByClassName('rm_customize_user_area_tab_icon')[0].value;

        if (ctabIconValue.trim() === '') {
            event.preventDefault(); // Prevent form submission
            alert(rm_admin_vars.custom_tab_icon_msg);
        // You can add more detailed validation messages or actions here.
        }

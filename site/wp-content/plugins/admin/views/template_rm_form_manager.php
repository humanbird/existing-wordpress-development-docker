...
<div class="rmagic rm-all-forms">
    <?php if(defined('REGMAGIC_BASIC')) {
        if(version_compare(RM_PLUGIN_VERSION, '5.3.0.0') >= 0) { ?>
        ...
        <div class="operationsbar" id="rmbar">
            ...
            <div class="nav" id="rm-ob-nav">
                <ul>
                    ...
                    <li id="rm-ob-demo" class="rm-starter-guide"><a target="_blank" href="https://registrationmagic.com/create-wordpress-registration-page-starter-guide/"><?php echo RM_UI_Strings::get('STARTER_GUIDE'); ?></a></li>
        ...
        if (is_array($data->data) || is_object($data->data))
            foreach ($data->data as $index=>$entry) {
              ...
              //Check if form is one of the sample forms.
                ...
                <div id="<?php echo $entry->form_id; ?>" class="rmcard <?php echo trim((string)$form_card_class . " rm-card-tour " . $ex_form_card_class); ?>">
                ...
                <div class="rm-box-col-12 rm-box-white-bg rm-form-box">                       
                    <div class="rm-modal-titlebar rm-new-form-popup-header">
                        <div class="rm-modal-title">
                            <?php _e('Add New Form', 'registrationmagic-addon'); ?>
                        </div>
                        <div class="rm-modal-subtitle">
                            <a href="<?php echo admin_url("admin.php?page=rm_form_setup");?>" title="<?php _e('Form Template', 'registrationmagic-addon'); ?>">
                              <?php _e('Or choose from a template.', 'registrationmagic-addon'); ?>
                            </a>

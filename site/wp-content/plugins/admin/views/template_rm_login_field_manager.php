                        ...
                        <div class="rm-field-submit-field-holder">
                            <div class="rm-field-submit-field">
                                <div class="rm-field-submit-field-btn-container rm-field-btn-align-<?php echo $btn_align; ?>">
                                    &#8203;
                                    <div class="rm-field-next-btn rm_field_btn" id="rm_field_login_button" title="Click to edit button label" contenteditable="true" spellcheck="false"><?php echo htmlentities(stripslashes((string)$login_label)); ?></div>
                                    &#8203;
                                    <div class="rm-field-sub-btn rm_field_btn" id="rm_field_register_button" title="Click to edit button label" contenteditable="true" spellcheck="false"><?php echo htmlentities(stripslashes((string)$register_label)); ?></div>
                                    &#8203;
                                </div>

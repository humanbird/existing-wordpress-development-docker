...
<!--                            <th>&nbsp;</th> -->
                            ...
                            <th><?php echo RM_UI_Strings::get("LABEL_EMAIL_SENT_ON"); ?></th>
...
<!--                                    <td>
                                    ...
                                    <td class="rm_data">
                                        <?php
                                            echo strip_tags(htmlspecialchars_decode((string)$mail->sub));
                                        ?>
                                    </td>
                                    <td class="rm_data">
                                        <?php
                                            echo RM_Utilities::localize_time($mail->sent_on);
                                        ?>
                                    </td>
                                    <td class="rm_data">
                                        <?php
                                            echo strip_tags(htmlspecialchars_decode((string)$mail->body));
                                        ?>
                                    </td>
                                    <td>

     ...
     <div class="rm-formflow-top-section" style="text-align: center">
       <div class="rm-formflow-top-action rm-form-design-wrap rm-formflow-top-action-center" >
             <ul class="rm-di-flex rm-d-flex-v-center rm-form-design-wrap">
                    ...
                    ?>
                    <li title="<?php echo esc_attr($design_link_tooltip); ?>"><a <?php echo wp_kses_post((string)$design_link_class); ?> href="?page=rm_form_sett_view&rdrto=rm_field_manage&rm_form_id=<?php echo esc_attr($data->form_id); ?>"><?php _e('Design','registrationmagic-addon'); ?></a></li>
                   <!-- <li><a id="rm_form_preview_action" class="thickbox rm_form_preview_btn" href="<?php echo add_query_arg(array('form_prev' => '1','form_id' => $data->form_id), get_permalink($data->prev_page)); ?>&TB_iframe=true&width=900&height=600"><?php _e('Preview','registrationmagic-addon'); ?></a></li> -->
                      <li><a id="rm_form_preview_action" class="rm_form_preview_btn" href="javascript:void(0)" data-form-id="<?php echo add_query_arg(array('form_prev' => '1','form_id' => $data->form_id), get_permalink($data->prev_page)); ?>"><?php _e('Preview','registrationmagic-addon'); ?></a></li>
                </ul>
         </div>
     </div>
     <!-- Step 2 -->
        ...
        <div class="rm_field_row_setting_wrap rm-select-row-setting rm-field-popup-out">
            <div class="rm-modal-titlebar rm-new-form-popup-header">
                <div class="rm-modal-title">
                    <?php _e('Form Preview', 'custom-registration-form-builder-with-submission-manager'); ?>
                </div>
                <span class="rm-modal-close rm-text-center">×</span>
            </div>
             <div id="rm-iframe-loader" class="rm-loader"></div>
            <iframe src="admin.php?page=rm_form_preview&rm_form_id=<?php echo esc_attr($data->form_id); ?>" height="600" width="100%" name="iframe_a" id="rm-form-preview-frame">

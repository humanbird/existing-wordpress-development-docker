...
<?php if(isset($data->actrl->date)) { 
            ...
            if(isset($data->actrl->date->question) && trim((string)$data->actrl->date->question))
...
<?php } 
      if(isset($data->actrl->passphrase)) { 
          ...
          if(isset($data->actrl->passphrase->question) && trim((string)$data->actrl->passphrase->question))

...
class RM_Utilities_Addon {
    ...
    public static function get_field_types($include_widgets = true, $form_type = 1) {
        $field_types = array(
            ...
            'URL' => __('URL','registrationmagic-addon'),
...
// format date string
    ...
    public static function get_validations_array() {
        $validations = array(
            ...
            "(https:\/\/www\.|http:\/\/www\.|https:\/\/|http:\/\/)?[a-zA-Z0-9]{2,}(\.[a-zA-Z0-9]{2,})(\.[a-zA-Z0-9]{2,})?" => __('Website', 'registrationmagic-addon'),
            "^[0-9]+$" => "Numeric",
    ...
    public static function get_allowed_conditional_fields() {
        return array('Textbox', 'Select', 'Radio', 'Checkbox', 'jQueryUIDate', 'Email', 'Number', 'Country', 'Website',
            'Language', 'Timezone', 'Fname', 'Lname', 'Phone', 'Mobile', 'Nickname', 'Bdate', 'Gender', 'Custom', 'Repeatable', 'Password', 'Terms', 'Repeatable_M', 'Textarea', 'Address', 'WCBilling', 'WCShipping', 'File', 'Image', 'HTMLH', 'HTMLP', 'Price');
    }
    ...
    public static function get_countries() {
        return array(
            ...
            "Syria[SY]" => __("Syria", "registrationmagic-addon"),

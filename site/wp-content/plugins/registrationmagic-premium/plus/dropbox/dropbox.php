...
final class RM_EX_DPX {
	...
	private function set_actions() { 
        ...
        {
            add_submenu_page("rm_dummy_string", __('RM Dropbox settings', 'registrationmagic-addon'), __('RM Dropbox settings', 'registrationmagic-addon'), "manage_options", "rm_form_sett_dropbox", array($this,'dpx_setting_manage'));
        }

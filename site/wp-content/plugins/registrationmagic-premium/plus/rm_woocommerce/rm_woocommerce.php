 ...
 * Description:       Seamless Integration between Woocommerce and RegistrationMagic
 * Version:           3.5.3.0
...
{    
     add_submenu_page("rm_dummy_string", __("RM Woocommerce settings",'registrationmagic-addon'), __("RM Woocommerce settings",'registrationmagic-addon'), "manage_options", "rm_form_sett_wc", 'rm_wc_form_sett_manage');
}

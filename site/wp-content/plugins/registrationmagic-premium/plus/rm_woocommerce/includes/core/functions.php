...
function rmwch_get_formatted_shipping_name_and_address($user_id, $newline_char="\n") {
    ...
    $address = array();
    $address[] = trim((string)get_user_meta( $user_id, 'shipping_first_name', true ).' '.get_user_meta( $user_id, 'shipping_last_name', true ));
    ...
    return trim((string)$f_add);
}

function rmwch_get_formatted_billing_name_and_address($user_id, $newline_char="\n") {

    $address = array();
    $address[] =  trim((string)get_user_meta( $user_id, 'billing_first_name', true ).' '.get_user_meta( $user_id, 'billing_last_name', true ));

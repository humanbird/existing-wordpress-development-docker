...
final class RM_EX_NLetter {
	...
	private function set_actions() { 
        ...
        {
             add_submenu_page("rm_dummy_string", __("RM Newsletter settings", 'registrationmagic-addon'),  __("RM Newsletter settings", 'registrationmagic-addon'), "manage_options", "rm_form_sett_newsletter", array($this,'form_sett_manage'));
        }

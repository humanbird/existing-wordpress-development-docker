                ...
                case 'rmfourthtabcontent': ?>                
                    ...
                    if (is_array($data->sent_emails) && count($data->sent_emails) !== 0) {
                        ...
                        foreach ($data->sent_emails as $email) {
                            ...
                            ?>
                            <tr><td><?php echo strip_tags(htmlspecialchars_decode((string)$email->sub)); ?></td><td><?php echo strip_tags(htmlspecialchars_decode((string)$email->body)); ?></td><td><?php echo RM_Utilities::localize_time($email->sent_on); ?></td><td><a href="?page=rm_sent_emails_view&rm_sent_email_id=<?php echo $email->mail_id; ?>"><?php echo RM_UI_Strings::get("VIEW"); ?></a></td>                            
                            </tr>
                            <?php
                        }
                    } else {

        ...
        <div class="settings-icon-area">
            ...
            <a href="admin.php?page=rm_licensing">
                <div class="rm-settings-box">
                    ...
                    <div class="rm-settings-subtitle"><?php echo RM_UI_Strings::get('GLOBAL_SETTINGS_LICENSE'); ?></div>
                    <span><?php echo RM_UI_Strings::get('GLOBAL_SETTINGS_LICENSE_EXCERPT'); ?></span>
                </div></a>

                    ...
                    <div class="rm-field-submit-field-holder">
                        <div class="rm-field-submit-field">
                            <div class="rm-field-submit-field-btn-container rm-field-btn-align-<?php echo $btn_align; ?>">
                                ...
                                <div class="rm-field-prev-btn rm_field_btn" id="rm_field_prev_button" title="<?php _e('Click to edit button label', 'registrationmagic-addon'); ?>" contenteditable="true" spellcheck="false" <?php echo $prev_btn_style; ?>><?php echo htmlentities(stripslashes((string)$prev_label)); ?></div>
                                &#8203;
                                <div class="rm-field-next-btn rm_field_btn" id="rm_field_next_button" title="<?php _e('Click to edit button label', 'registrationmagic-addon'); ?>" contenteditable="true" spellcheck="false"><?php echo htmlentities(stripslashes((string)$next_label)); ?></div>
                                &#8203;
...
<!--                                        <input type="radio" name="rm_field_submit_field_align" value="left" id="rm_field_submit_field_align_left" <?php // echo $lalign_check_state;  ?> ><label for="rm_field_submit_field_align_left"><?php //echo RM_UI_Strings::get('LABEL_LEFT'); ?></label>
    ...
    <!--- Password delete PopUp -->
        <div id="rm-userpassword-delete" class="rm-modal-view" style="display:none">
            ...
            <div class="rm-modal-wrap">
                <div class="rm-modal-titlebar">
                    <div class="rm-modal-title"><?php _e('Delete Password Field', 'registrationmagic-addon'); ?></div>
                    <span  class="rm-modal-close">&times;</span>
                </div>
                <div class="rm-modal-container">
                    <?php _e('After removing the Password Field, passwords will be automatically generated and emailed to the user on successful registration. Do you wish to proceed?', 'registrationmagic-addon'); ?>
                </div>

...
<form action="" id="rm_form_add_new_form" method="post" class="form-horizontal">
    ...
    <div class="rm-create-new-from">
        <div class="rm-form-name rm-dbfl">
            ...
            <div class="rm-form-name-input rm-dbfl"><input type="text" name="form_name" id="form_name" value="Form <?php echo $last_form_id+1; ?>"/></div>
            <div class="rm-text-end rm-inline-block rm-box-w-100"><a href="javascript:void(0)" onclick="showOptionalSetting()" class="rm-text-small rm-optional-setting-toggle rm-text-decoration-none"><?php _e('Optional settings','registrationmagic-addon'); ?> <span class="dashicons dashicons-arrow-down"></span></a></div>
            <div class="rm-form-name-input rm-form-additional-info rm-dbfl rm-pb-2" id="rm-form-additional-info" style="display: none;">
                ...
                <label for="rm_form_type" class="rm-text-small"><?php _e('Turn off user account creation.', 'registrationmagic-addon'); ?></label>
            </div>
        </div>  

        <div class="rm-create-new-from-btn-area ep-pt-2 rm-text-start rm-inline-block rm-box-w-100">    
            <input type="submit" value="<?php _e("Save", 'registrationmagic-addon') ?>" name="submit" id="rm_submit_btn" onclick="rm_handle_new_form_creation(event)" class="rm_btn button action button-primary">
        </div>

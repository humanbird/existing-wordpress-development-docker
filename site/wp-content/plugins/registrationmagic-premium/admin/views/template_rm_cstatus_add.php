...
<div class="rmagic">
    ...
    <div class="rmcontent">
        ...
        //$form->addElement(new Element_HTML('<div class="rmnotice-row rm-custom-status-note"><div class="rmnotice">'.__('You can assign statuses to registrations from the ','registrationmagic-addon').'<a href="admin.php?page=rm_submission_manage">inbox</a>.'.'</div></div>'));

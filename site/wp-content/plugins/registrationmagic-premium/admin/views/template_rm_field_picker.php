...
<div class="field-selector-pills">
    ...
    <div class="rm-field-tabs-row rm-dbfl">
        ...
        <div id="rm_special_fields_tab">
            ...
            <div title="<?php echo RM_UI_Strings::get("FIELD_HELP_TEXT_Url"); ?>" class="rm_button_like_links" onclick="add_new_field_to_page('URL')">       <a href="javascript:void(0)"><?php echo RM_UI_Strings::get("FIELD_TYPE_URL"); ?></a></div>

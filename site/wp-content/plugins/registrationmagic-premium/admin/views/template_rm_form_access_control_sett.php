...
$login_cb_value = isset($actrl->login) ? 1 : 0;
...
<div class="rmagic">
    ...
    <div class="rmcontent">
        ...
        $form->addElement(new Element_Checkbox("<b>" . RM_UI_Strings::get('LABEL_ACTRL_LOGIN') . "</b>", "form_actrl_login", array(1=>''), array("id" => "id_form_actrl_login", "value" => $login_cb_value, "longDesc" => RM_UI_Strings::get('HELP_FORM_ACTRL_LOGIN'))));

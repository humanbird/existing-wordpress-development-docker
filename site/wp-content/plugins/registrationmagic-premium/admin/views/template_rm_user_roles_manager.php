        ...
        {   $gopts = new RM_Options;
            ...
            foreach ($data->roles->custom as $role => $role_name)
            {
                ...
                if(isset($data->custom_role_data[$role]) && $data->custom_role_data[$role]->is_paid){
                   $paid_role = true;
                   $paid_role_price = $data->custom_role_data[$role]->amount;
                ...
                <li id="<?php echo $role;?>">
                    <div class="rm-slab">
                        ...
                        <div class="rm-slab-buttons" onclick="delete_role(this,'checkbox_<?php echo $role_without_spaces; ?>')">
                         ...
                         <a class="rm-slab-buttons rm-role-edit" onclick="rm_role_edit(this, '<?php echo $role;?>','<?php echo $role_name; ?>','<?php echo $paid_role;?>','<?php echo $paid_role_price;?>')">Edit</a>
                    </div>
                </li>
...
function rm_role_edit(element, key, rolename, paid, price){
    ...
    console.log(paid);
    if(paid){
        jQuery('#rm_is_paid_cb-0').attr('checked',true);
        jQuery('#rm_role_price_container').show();
        jQuery('#rm_role_price').val(price);
    }
}   
</script></pre>

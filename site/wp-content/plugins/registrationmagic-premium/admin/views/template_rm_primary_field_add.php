...
if(strtolower($data->model->field_type)=="userpassword" || strtolower($data->selected_field)=='userpassword'){
    $form->addElement(new Element_Checkbox("<b>".esc_html__('Display password confirmation field','registrationmagic-addon')."</b>", "en_confirm_pwd", array('1'=>''), array("class" => "rm_field_multiline rm_input_type en_confirm_pwd", "value" => $data->model->field_options->en_confirm_pwd, "longDesc"=>sprintf(__('Display a password confirmation field below the password field. <a target="_blank" class="rm-more" href="%s">More</a>','registrationmagic-addon'),'https://registrationmagic.com/knowledgebase/password-field-settings/#htdisplayconfirmation'))));
        $form->addElement(new Element_HTML('<div class="childfieldsrow" id="confirm_pwd_options">'));
        $form->addElement(new Element_Textbox("<b>" . esc_html__('Confirm password field label','registrationmagic-addon') . "</b>", "cnf_pass_label", array("id" => "rm_field_class", "class" => "rm_static_field", "value" => empty($data->model->field_options->cnf_pass_label) ? RM_UI_Strings::get('LABEL_PASSWORD_AGAIN') : $data->model->field_options->cnf_pass_label, "longDesc"=>'')));
        $form->addElement(new Element_Radio("<b>" . esc_html__('Confirm password field position','registrationmagic-addon') . "</b>", "cnf_pass_position", array('right'=>esc_html__('Right','registrationmagic-addon')."<div class='rm-password-right'></div>",'below'=>esc_html__('Below','registrationmagic-addon')."<div class='rm-password-below'></div>"), array("value" => isset($data->model->field_options->cnf_pass_position) ? $data->model->field_options->cnf_pass_position : 'right', "longDesc"=>'')));
        $form->addElement(new Element_Textarea("<b>".esc_html__('Password match error','registrationmagic-addon')."</b>", "pass_mismatch_err", array("class" => "", "value" =>$data->model->field_options->pass_mismatch_err , "longDesc" => sprintf(__('Contents of the error message user sees when the password entered in password confirmation field does not matches. <a target="_blank" class="rm-more" href="%s">More</a>','registrationmagic-addon'),'https://registrationmagic.com/knowledgebase/password-field-settings/#htmatcherror'))));
        $form->addElement(new Element_HTML('</div>'));
